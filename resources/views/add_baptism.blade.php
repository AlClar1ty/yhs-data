...
<div class="container">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active font-weight-bold" aria-current="page">Add Baptismi</li>
      </ol>
    </nav>
    <div class="row justify-content-center">
        <div class="col-md-12">
            <form id="formAdd" action="{{ route('baptism_store') }}" method="POST">
                @csrf
                <div class="card my-1">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-3 col-12">
                                ...
                                <input type="tel" class="form-control" id="phone" name="phone" required="" placeholder="No. Telp">
                            </div>
                            <div class="form-group col-md-6 col-12">
                                <label for="father_name">Nama Ayah</label>
                                <input type="text" class="form-control" id="father_name" name="father_name" required="" placeholder="Nama Ayah">
                            </div>
                            <div class="form-group col-md-6 col-12">
                                <label for="mother_name">Nama Ibu</label>
                                <input type="text" class="form-control" id="mother_name" name="mother_name" required="" placeholder="Nama Ibu">
                            </div>
                            <div class="col-12">
                            ...
                            <div class="form-group col-12 col-md-4">
                                ...
                                <input type="date" class="form-control" id="baptism_date" name="baptism_date" required="" placeholder="Tanggal Baptis">
                            </div>
